...
@Component
public class JsonAwareAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    private final ObjectMapper objectMapper;
    private final JwtTokenFactory tokenFactory;

    @Autowired
    public JsonAwareAuthenticationSuccessHandler(ObjectMapper objectMapper, JwtTokenFactory tokenFactory) {
